...
export type SkillCategory = 'Frontend' | 'Backend' | 'DevOps' | 'Qualité' | 'Accessibilité' | 'Leadership' | 'IA';
...
export const CATEGORY_ORDER: SkillCategory[] = [
  'Frontend', 'Backend', 'DevOps', 'Qualité', 'Accessibilité', 'Leadership', 'IA',
];
...
export const skills: Skill[] = [
  ...
  { name: 'Next.js',       category: 'Frontend', size: 'm', mono: true },
  ...
  // DevOps
  { name: 'Ansible',        category: 'DevOps', size: 'l', mono: true },
  { name: 'Docker',        category: 'DevOps', size: 's', mono: true },
  { name: 'CI / CD',       category: 'DevOps', size: 'm', mono: true },
  { name: 'Github Actions',       category: 'DevOps', size: 'm', mono: true },
  // Qualité
  ...
  { name: "Lecteurs d'écran", category: 'Accessibilité', size: 's', mono: true },
  // Leadership
  { name: 'Lead technique',   category: 'Leadership', size: 'l' },
  { name: 'Architecture',     category: 'Leadership', size: 'l' },
  { name: 'Mentorat',         category: 'Leadership', size: 'm' },
  { name: 'Pair programming', category: 'Leadership', size: 'm' },
  { name: 'Pédagogie',        category: 'Leadership', size: 'm' },
  { name: 'Recrutement tech', category: 'Leadership', size: 's' },
  { name: 'Bienveillance',    category: 'Leadership', size: 'l' },
  { name: 'Pragmatisme',      category: 'Leadership', size: 'xl' },
  // IA
